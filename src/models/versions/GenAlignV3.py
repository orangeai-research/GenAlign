...
class GenAlignGUME(GeneralRecommender):
    def __init__(self, config, dataset):
        ...
        self.rf_model = RectifiedFlow(self.embedding_dim).to(self.device)
    ...
    def calculate_loss(self, interaction):
        ...
        batch_image_item = explicit_image_embeds[unique_items]
        batch_text_item = explicit_text_embeds[unique_items]
        rf_loss = self.rf_weight * self.rf_model.compute_loss(batch_image_item, batch_text_item)
        
        return bpr_loss + al_loss + um_loss + reg_loss + rf_loss
